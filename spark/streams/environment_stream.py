...
def process_environment_stream(spark):
    ...
    # 3. Traitement : Calculate average temperature and air quality by district over a time window.
    # The watermark handles late-arriving data.
